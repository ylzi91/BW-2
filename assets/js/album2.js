    ...
    function displayAlbums(albums, playlistDown, otherAlbums) {
        ...
        hero.innerHTML = ` <div class="heroImg">
          ...
          <div class="p-2 hero-content">
           ...
           <a class="text-decoration-none text-white"  href = "./album.html?myId=${albums[indexRand].id}" target = "_blank"> <h1 class="m-0 p-2">${albums[indexRand].title}</h1></a>
           <a class="text-decoration-none text-white"  href = "./artist.html?myId=${albums[indexRand].artist.id}" target = "_blank"> <p class="m-0 p-2">${albums[indexRand].artist.name}</p></a>
