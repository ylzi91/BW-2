    ...
    function displayAlbums(albums, playlistDown, otherAlbums) {
        ...
        hero.innerHTML = ` <div class="heroImg">
          ...
          <div class="p-2 hero-content">
           ...
           <a href = "./album.html?myId=${albums[indexRand].id}" target = "_blank"> <h1 class="m-0 p-2">${albums[indexRand].title}</h1></a>
           <a href = "./artist.html?myId=${albums[indexRand].artist.id}" target = "_blank"> <p class="m-0 p-2">${albums[indexRand].artist.name}</p></a>
        ...
        albums.forEach((album) => {
            ...
            albumContainer.innerHTML += `
              ...
              <div class="d-flex justify-content-center align-items-center gradient-card rounded">
                <img src="${album.album.cover_small}" class="m-0 img-fluid rounded-start w-25 " />
        ...
        playlistDown.forEach((itemList) => {
            ...
            list.innerHTML += `
              ...
              <div class="d-flex flex-column justify-content-center align-items-start gradient-card rounded">
                <img src="${itemList.artist.picture_medium}" class="m-0 img-fluid rounded w-100 " />
